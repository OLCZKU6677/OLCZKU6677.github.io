...
public class CheatyCommand implements CommandExecutor {
    ...
    public CheatyCommand(WOOLCODESPRAWDZANIE plugin) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("woolcodesprawdzanie.cheaty")) {
            player.sendMessage(messagesManager.getMessage("noHasPermission")
                    .replace("{PERMISSION}", "woolcodesprawdzanie.cheaty"));
            return true;
        }
        ...
        // Logika banowania za cheaty
        player.sendMessage(messagesManager.getMessage("checkPlayerBanBroadcast")
